...
import { showDialog, showNotification } from '../../core/dialog.mjs'
 ...
 * Claude window. If the last assistant message looks like a question, show a
 * small "Claude is waiting" dialog whose primary button jumps the user back to
 * the Claude window (where they type the reply themselves — no cramped inline
 * box). Otherwise fire a tiny completion banner.
 *
 * Always returns null: we never inject text, we just notify / refocus.
 *
